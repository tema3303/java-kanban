public class Main {
    public static void main(String[] args) {
        ...
        SubTask subTask3 = new SubTask("Subtask 3", "Описание подзадачи 2", Status.NEW,epic2.getId());
        ...
        manager.updateSubTask(new SubTask("Subtask 1", "Описание подзадачи 1", Status.DONE,epic1.getId()),5);
        manager.updateSubTask(new SubTask("Subtask 1", "Описание подзадачи 1", Status.IN_PROGRESS,epic2.getId()),6);
